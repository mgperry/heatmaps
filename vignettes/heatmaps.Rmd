...
plotHeatmapList(h3k4me3_30p_subtracted_hm, cex.label=1.5, color=c("red", "white", "blue"), legend=TRUE)
```
...
ta_30p_smoothed = smooth(ta_30p, output.size=c(250, 500), method="kernel")
...
plotHeatmapList(smooth(tata_pwm_30p, output.size=c(250, 500)))
```
...
tata_pwm_scan_30p_smoothed = smooth(tata_pwm_scan_30p, method="blur", output.size=c(250, 500))
scale(tata_pwm_scan_30p_smoothed) = c(40, 60)
plotHeatmapList(tata_pwm_scan_30p_smoothed, color="Spectral", legend=TRUE)
```
...
cg_30p_smoothed = smooth(cg_30p, output.size=c(250, 500))
...
plotHeatmapList(list(ta_30p_smoothed, cg_30p_smoothed, smooth(h3k4me3_30p_heatmap), tata_pwm_scan_30p_smoothed), 
                groups=c(1, 1, 2, 3),
                color=list("Blues", "Spectral", "Greens"),
...
SmoothPatternHM = function(seq, pattern, ...) {
    ...
    smooth(hm, output.size=c(200, 200))
}
